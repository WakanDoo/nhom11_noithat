  ...
  return (
    <div className="bg-white">
      <main className="w-full overflow-hidden bg-white">
        <Link href="/product/sofa-setup" className="group block">
        ...
        <Link href="/product/sofa-bubble" className="group block">
        ...
        <Link href="/product/dining_tables_chairs-serpentine" className="group block">
