    ...
    <div className="flex flex-col flex-1 bg-white">
      <main className="w-full flex justify-center">
        <div className="relative w-[1280px] h-[732px] bg-white">
          ...
          {/* Top divider line: y=119 across full width */}
          ...
          <div className="absolute left-0 top-[119px] w-[404px] h-[613px]">
            ...
            <div className="absolute left-[8px] top-[406px] text-[26px] font-bold text-[#0A0A0A] [font-family:var(--font-inter),_system-ui] leading-[1.1672] [text-decoration:none]">
