              ...
              <div className="w-full pb-20 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square">
                    <Image src="/picture/construction3/rectangle 39.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction3/rectangle 40.png" alt="" fill className="object-cover"/>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square]">
                    <Image src="/picture/construction3/rectangle 41.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction3/rectangle 42.png" alt="" fill className="object-cover"/>
                  </div>
                </div>

                {/* Row 3 (full) */}
                <div className="relative h-[500px]">
                  <Image src="/picture/construction3/rectangle 43.png" alt="" fill className="object-cover"/>
                </div>

                {/* Row 4 */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square">
                    <Image src="/picture/construction3/rectangle 44.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction3/rectangle 45.png" alt="" fill className="object-cover"/>
                  </div>
                </div>

                {/* Row 5 (full) */}
                <div className="relative h-[500px]">
                  <Image src="/picture/construction3/rectangle 46.png"alt="" fill className="object-cover"/>
                </div>
