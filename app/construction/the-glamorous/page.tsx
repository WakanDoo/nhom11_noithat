              ...
              <div className="w-full pb-20 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square">
                    <Image src="/picture/construction2/rectangle 30.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction2/rectangle 31.png" alt="" fill className="object-cover"/>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square]">
                    <Image src="/picture/construction2/rectangle 32.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction2/rectangle 33.png" alt="" fill className="object-cover"/>
                  </div>
                </div>

                {/* Row 3 (full) */}
                <div className="relative h-[500px]">
                  <Image src="/picture/construction2/rectangle 34.png" alt="" fill className="object-cover"/>
                </div>

                {/* Row 4 */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative aspect-square">
                    <Image src="/picture/construction2/rectangle 35.png" alt="" fill className="object-cover"/>
                  </div>
                  <div className="relative aspect-square">
                    <Image src="/picture/construction2/rectangle 37.png" alt="" fill className="object-cover"/>
                  </div>
                </div>
